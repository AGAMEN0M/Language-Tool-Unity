...
[AddComponentMenu("Language/UI/Legacy/Adjust Size To Dropdown")]
public class AdjustSizeToDropdown : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Text[] textComponents = GetComponentsInChildren<Text>(); // Get all Texts in the hierarchy.
