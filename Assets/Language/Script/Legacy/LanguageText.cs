...
[AddComponentMenu("Language/UI/Legacy/Language Text")]
public class LanguageText : MonoBehaviour
{
    ...
    public class LanguageTextEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            LanguageText script = (LanguageText)target; // Get the target LanguageText component.
        ...
        public void AddLanguageSaveID(LanguageText script)
        {
            ...
            if (existingLanguageSaveID != null)
            {
                ...
                existingLanguageSaveID.text = script.languageText.text;
    ...
    [Header("Settings")]
    public Text languageText; // Reference to the Text component for displaying the localized text.
    ...
    private void ProcessLanguageOption(string line)
    {
        ...
        { languageText.font = fontListObject.fontList[font - 1]; }

        if (languageText.TryGetComponent<RectTransform>(out var rectTransform))
        {
        ...
        if (translateText)
        {
            ...
            languageText.text = text; // Update the text of the language text component.
        }
    }
    ...
    private void SetTextAlignment()
    {
        ...
        if (alignment >= 1 && alignment <= 3)
        {
            ...
            string verticalAlignment = TextAlignmentConverter.GetVerticalAlignmentFromTextAlignment(languageText.alignment);
            ...
            languageText.alignment = newAlignment; // Sets the new alignment in the text component.
        }
    }
    ...
    {
        RectTransform rectTransform = languageText.GetComponent<RectTransform>(); // Get the RectTransform for positioning and sizing.
        ...
        fontSize = languageText.fontSize; // Save the font size.

        // Determine the alignment based on the TextAnchor enumeration.
        if (languageText.alignment == TextAnchor.UpperLeft || languageText.alignment == TextAnchor.MiddleLeft || languageText.alignment == TextAnchor.LowerLeft)
        {
            alignment = 1; // Left alignment.
        }
        else if (languageText.alignment == TextAnchor.UpperCenter || languageText.alignment == TextAnchor.MiddleCenter || languageText.alignment == TextAnchor.LowerCenter)
        {
            alignment = 2; // Center alignment.
        }
        else if (languageText.alignment == TextAnchor.UpperRight || languageText.alignment == TextAnchor.MiddleRight || languageText.alignment == TextAnchor.LowerRight)
        {
            alignment = 3; // Right alignment.
        }

        // Determine the index of the font in the fontListObject.
        Font fontTemp = languageText.font;
