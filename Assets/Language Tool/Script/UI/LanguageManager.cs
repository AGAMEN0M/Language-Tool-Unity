/*
 * ---------------------------------------------------------------------------
 * Description: This component manages language selection through a 
 *              Dropdown interface. It detects the system language, loads available 
 *              language files, and allows the user to select a language. The selected 
 *              language is saved for future sessions, and updates the application 
 *              accordingly.
...
{
    [Header("Settings")]
    [SerializeField] private Dropdown dropdown; // Dropdown for selecting language.
    [Space(10)]
